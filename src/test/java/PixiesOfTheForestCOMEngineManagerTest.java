...
public class PixiesOfTheForestCOMEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(PixiesOfTheForestCOMEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/PixiesOfTheForestIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/PixiesOfTheForestIW/InitOutcome.xml").getDocumentElement();
